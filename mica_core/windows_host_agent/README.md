...
`python mica_core\windows_host_agent\mtls_probe.py --connect-host 127.0.0.1 --host host.docker.internal --ca C:\ProgramData\Mica\tls\broker-ca.crt --cert C:\ProgramData\Mica\tls\client.crt --key C:\ProgramData\Mica\tls\client.key --output artifacts\phase0-mtls-current.json`
...
`python -m uvicorn mica_core.windows_host_agent.app:app --host 127.0.0.1 --port 8766`
