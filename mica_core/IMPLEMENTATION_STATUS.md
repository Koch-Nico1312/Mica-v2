...
| Bestehender Mark-Pfad bleibt erhalten | erfüllt | neuer Core ist additiv unter `mica_core`; bestehende Desktopdateien und uncommittete Änderungen wurden erweitert statt zurückgesetzt | Gemini erst nach erfolgreicher Offline-Zielabnahme aus dem aktiven Betrieb entfernen |
