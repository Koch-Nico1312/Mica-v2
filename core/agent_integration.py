...
from agent_coordinator import AgentCoordinator, AgentType, AgentTask
from model_router import ModelRouter, ModelTier, TaskComplexity
from isolated_plugin_loader import IsolatedPluginLoader
...
class AgentIntegration:
    ...
    def inspect_project(self, project_root: Path | str) -> dict[str, Any]:
        ...
        if not self.code_agent:
            self.code_agent = CodeAgent(project_root, logger=self.logger)
